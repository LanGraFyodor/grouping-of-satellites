...
public class SatelliteConstellation {
    ...
    public Satellite removeSatellite(String satelliteName) {
        Satellite satellite = findSatellite(satelliteName);
        satellites.remove(satellite);
        satellite.deactivate();
        return satellite;
    }

    public Satellite findSatellite(String satelliteName) {
