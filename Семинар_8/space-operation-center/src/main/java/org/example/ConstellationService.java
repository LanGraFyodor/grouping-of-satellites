...
public class ConstellationService {
    ...
    public Satellite removeSatellite(String constellationName, String satelliteName) {
        return requireConstellation(constellationName).removeSatellite(satelliteName);
    }
    ...
    public String getOverview() {
        StringBuilder overview = new StringBuilder("Сводка спутниковой системы");
        constellationRepository.findAll().values().forEach(constellation -> {
